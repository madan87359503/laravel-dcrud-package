...
class Forms extends Model
{
  ...
  array (
    ...
    'formclass' => 'col-lg-2',
    'defaultvalue' => NULL,
    'options' => '[\'text\'=>\'text\',\'dropzone\'=>\'dropzone\',\'editorjs\'=>\'editorjs\',\'select\'=>\'select\',\'switch\'=>\'switch\',\'radio\'=>\'radio\',\'hidden\'=>\'hidden\']',
    'sortale' => 0,
    'searchableforms' => 0,
  ),
  'modeldata' => 
  ...
  array (
    ...
    'searchableforms' => 0,
		...
		public static function getSelectData(){
			$options=[];
		 $options["models_name"]=\Madan\Dcrud\Models\Models::pluck("name","id")->prepend("Select One...","");;$options["type"]=['text'=>'text','dropzone'=>'dropzone','editorjs'=>'editorjs','select'=>'select','switch'=>'switch','radio'=>'radio','hidden'=>'hidden'];
