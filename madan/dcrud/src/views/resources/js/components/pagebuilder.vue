<template>
    ...
    <div style='overflow:auto;width:100%;min-height:600px;position:relative'>
...
<form action='{{url('component')}}' method='post' enctype="multipart/form-data" class='padding' id='componentform'>
    @csrf
     <textarea  v-model='componentarea' class=' padding-min hidden' rows=1 cols=25 placeholder='Content' name='content' id='content'></textarea>
<input name='cactions_name' value=1 type='hidden'>
    <select class=' padding-min' id='type' name='type' >
      <option value='page'>Page</option>
      <option value='file'>File</option>
      <option value='api'>API/ROUTE</option>
      <option value='static'>Static Data</option>
  </select>
   <input class=' padding-min' type="text" title="name" required="true" maxlength="255"  name="name" id='name'  placeholder='Component Name'>
 <input class=' padding-min' type="text" title="datasource" required="true" maxlength="255" name="datasource" id="datasource" value="" placeholder='Data Source'>
   <input type="file" style='float:left;' id="preview" title="Preview" class='padding-min'  name="preview" onchange='setFile(this.value)'>
  <input type='submit' value='Upload/Publish' >
